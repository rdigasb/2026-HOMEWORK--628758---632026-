...
/**
 *Classe che estende la classe StanzaProtected, differisce da essa
 *poichè se si posa un oggetto più di tot volte nella stanza
 *il nome dell'oggetto viene invertito e il peso raddoppiato. 
 *Differisce dalla classe "StanzaMagica" perchè può utilizzare
 *le variabili presenti nella sua super classe  
